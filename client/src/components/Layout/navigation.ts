...
export const NAVIGATION_ITEMS = [
  ...
  { to: '/pipeline', label: 'Funil de vendas', icon: Kanban, permission: 'screen.pipeline' },
  { to: '/pipeline-operacional', label: 'Operação', icon: ClipboardList, permission: 'screen.pipeline_operacional' },
